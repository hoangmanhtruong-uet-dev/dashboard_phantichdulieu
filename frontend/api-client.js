(function createNexusApiClient(global) {
  ...
  global.NexusAPI = {
    ...
    retention: options => client.get('/api/analytics/retention', options),
    segments: options => client.get('/api/analytics/segments', options),
    anomalies: options => client.get('/api/analytics/anomalies', options),
    forecast: (query = {}, options) => client.get(`/api/analytics/forecast${buildQuery(query)}`, options),
    insightExplanations: options => client.get('/api/analytics/insights/explanations', options),
